...
universes. The x-axis shows the DE effect, the y-axis shows the DD effect, and
color/shape mark FDR significance and curated marker-list membership.

![DE and DD effect-size comparison for genes tested in both analyses. Points are genes; x shows the DE effect, y shows the DD effect, and color/shape indicate FDR significance and curated marker-list membership.](figures/mg_selected_de_dd_effect_scatter.png){#fig-mg-selected-de-dd-effect-scatter}
