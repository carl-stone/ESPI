...
marker-list hits. The paired sensitivity DD tested 34,880 genes and found 40
FDR-significant genes, with no marker-list hits.

I interpret genes with concordant primary and paired-sensitivity effects as the
strongest design-robust signals. Paired-only DE or DD hits are within-paired-mice
sensitivity results, not evidence that the paired model is globally more
accurate than the all-sample primary condition model.
