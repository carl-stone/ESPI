...
The cluster-abundance summary compares E-Stim and control cells within this
chosen clustering. Bars show CLR log2 enrichment of cluster abundance in E-Stim
versus control; colors distinguish enriched or depleted clusters with
significant pooled cell-level Fisher tests after Holm correction. This is
descriptive and does not use the Mouse × Condition pseudobulk unit used for
DE/DD.
