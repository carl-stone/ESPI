...
Cluster 10 is clearly microglia. Cluster 13 has high p27 expression. No cluster met the photoreceptor exclusion criteria. I filtered out clusters 10 and 13, then re-ran PCA and clustering on the remaining cells.
...
* Cluster 4 is enriched for microglia-associated genes (`Tyrobp`, `Spp1`, `C1qb`).
* Cluster 12 is enriched for neuronal genes (`Gpr61`, `Elfn2`, `St8sia3`).
* Cluster 19 is enriched for cell-cycle-associated genes (`Ankle1`, `Ercc6l`, `Raet1e`).
