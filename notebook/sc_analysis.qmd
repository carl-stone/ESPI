...
The Fisher/CLR cluster-abundance summary compares pooled E-Stim and control
cells within this chosen clustering. Bars show CLR log2 enrichment of cluster
abundance in E-Stim versus control; colors distinguish enriched or depleted
clusters with significant pooled cell-level Fisher tests after Holm correction.
...
![MG-selected cluster abundance enrichment for the chosen PFlog clustering. Bars show CLR log2 enrichment of cluster abundance in E-Stim versus control; colors distinguish enriched and depleted significant Fisher/Holm results.](figures/mg_selected_cluster_abundance_enrichment_pflog_mg_selected_no_filter_cc_dims30_res0.3.png){#fig-mg-selected-cluster-abundance-clr-fisher}
