...
![Clustree grid across normalization, cell-cycle-HVG policy, and PC count. Each panel shows the resolution sweep for one branch.](figures/cluster_grid_clustree_12_panel.png){#fig-clustree-grid}

The representative UMAP sweep below uses the current ARI reference branch: PFlog normalization, cell-cycle HVGs filtered, 50 PCs. It shows how increasing Leiden resolution subdivides the same UMAP geometry.
