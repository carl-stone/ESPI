...
All future work items, ideas, and planned improvements for this project are tracked here. Each item may have a dedicated `.md` file in this directory with full details.
...
| Priority | Meaning |
|----------|---------|
| `critical` | Blocks progress or correctness |
| `high` | Important and should be done soon |
| `medium` | Valuable but not urgent |
| `low` | Nice to have |
| `idea` | Speculative, no commitment |
...
| Standardize stable references for cross-referenced artifacts | medium | complete | writing | 2026-07-05 | OMP agent | [stable-cross-references.md](stable-cross-references.md) |
| Create shared three-color analysis palette | medium | complete | infrastructure | 2026-07-05 | OMP agent | [shared-three-color-analysis-palette.md](shared-three-color-analysis-palette.md) |
