...
#   cell_type_marker_heatmap_<layer>_<branch_tag>_cells_dims<dims>_res<resolution>.(png|pdf).
...
out_tag <- sprintf(
  "cell_type_marker_heatmap_%s_%s_cells_dims%s_res%s",
  expression_layer,
  branch_tag,
  dims,
  resolution
...
grDevices::png(png_path, width = 10, height = 9, units = "in", res = 300)
ComplexHeatmap::draw(
  heatmap,
...
grDevices::pdf(pdf_path, width = 10, height = 9)
ComplexHeatmap::draw(
  heatmap,
  heatmap_legend_side = "right",
  annotation_legend_side = "right"
