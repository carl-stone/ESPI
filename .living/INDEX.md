...
- **r-package** (4 entries) — L-6, D-1, D-3, D-8
- **clustering** (3 entries) — L-4, D-5, D-6
- **marker-genes** (3 entries) — L-6, D-7, D-8
- **plotting** (3 entries) — L-5, L-6, D-8
...
- [2026-07-03] L-6: Use ASCII keys plus labels for marker sets
- [2026-07-03] L-7: Use unlink for notebook figure symlink replacement
