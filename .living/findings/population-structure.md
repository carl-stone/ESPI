...
**Status:** preliminary
**Claim:** In the current MG-selected chosen clustering, cluster 8 is a 17-cell outlier with strong descriptive marker separation, including `Cnmd`, `Scrg1`, `Gja1`, `Ccdc190`, and `Cldn19`.
