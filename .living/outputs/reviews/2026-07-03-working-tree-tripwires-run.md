...
**Result**: 4 PASS, 0 FAIL, 2 SKIP

## Results

| Status | Slug | Message |
|---|---|---|
| PASS | `branch-artifact-collision` | Cluster columns, UMAP reductions, clustree tags, and clustered RDS names use the normalization + cell-cycle branch tag contract. |
| PASS | `report-values-freshness` | HTML is newer than QMD and 10 referenced figure target(s); prose states top 20 HVGs and 500 cells. |
