...
Keep this file operational and compact; repo code is the source of truth.
If a scientific detail is absent, ask the user for clarification rather than making assumptions.
...
Run `devtools::document()` after modifying any code in `R/` to update the package documentation.
NEVER edit .Rd files directly; they are generated from the R code and roxygen2 comments.
