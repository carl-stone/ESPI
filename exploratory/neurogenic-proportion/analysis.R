...
suppressPackageStartupMessages({
  library(here)
  here::i_am("exploratory/neurogenic-proportion/analysis.R")
...
if (!file.exists(input_path)) {
  cli::cli_abort(c(
    ...
    "i" = paste(
      "Run exploratory/milo/module-score-milo-da.R first or set",
...
settings <- tibble::tibble(
  ...
  value = c(
    ...
    file.path("exploratory", "neurogenic-proportion", "outputs"),
