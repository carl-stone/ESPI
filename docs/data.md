...
- `notebook/figures/`: PNGs referenced by inline Markdown image paths in
  `notebook/sc_analysis.qmd`. Pipeline writers still generate their primary
  outputs in Box; they no longer mirror unreferenced variants into the repo.
