...
- Six Mouse × Condition pseudobulk samples: mice 10 and 3 are paired, mouse 30
  is E-Stim only, and mouse 33 is control only.
- Platform: PipSeq V T2 with a custom reference including eGFP.
- Primary statistical unit for condition-level DE: Mouse × Condition sample,
  not cell.
