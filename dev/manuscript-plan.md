...
Date: 2026-07-17
Status: manuscript drafting snapshot. The results and status descriptions below
...
- Retained cells: 3,238.
- Selected downstream clustering: PFlog/no-filter-CC, 20 PCs, Leiden resolution 0.3, seed 2847, with 5 clusters. The cell-cycle-filtered sensitivity branch retains seed 1312 and 6 clusters. MG PCA/candidate depth: 50.
...
- Primary DE tested 17,043 genes and found 448 FDR-significant genes: 139 higher with E-Stim and 309 lower with E-Stim.
- Significant curated marker-list genes:
  - Higher with E-Stim: `Glul` (log2FC 0.9362, padj 1.10e-05), `Ccn1` (0.7180, 0.00490), `Hes6` (0.6779, 0.0174), and `Grm6` (1.77, 0.0106).
  - Lower with E-Stim: `Mcm2` (-1.8349, 8.30e-06), `Mcm6` (-0.0543, 0.0267), `Pcna` (-0.9137, 0.00259), and `Rcvrn` (-2.10, 0.00264).
- Paired sensitivity found 125 FDR-significant genes and preserves `Glul` (log2FC 1.04, padj 0.00387), `Ccn1` (0.815, 0.0282), `Mcm2` (-1.29, 0.00188), and `Mcm6` (-1.61, 0.000397); it does not preserve `Hes6`, `Pcna`, `Grm6`, or `Rcvrn` at FDR < 0.05.
...
- The current choice is 20 PCs at resolution 0.3; the MG PCA/candidate depth is 50.
...
- The notebook-facing result states 139 genes increased and 309 decreased with E-Stim.
